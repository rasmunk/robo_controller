...
VideoHandler::VideoHandler(unique_ptr<FrameStructure> structure)
...
VideoHandler::VideoHandler(shared_ptr<FrameStructure> shared_structure)
...
cv::Size VideoHandler::get_frame_size() { return _frame_size; }
