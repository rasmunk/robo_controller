...
LayeredNeuralNetwork::LayeredNeuralNetwork(std::vector<double>& weights, unsigned int nbInputs,
    unsigned int nbOutputs, bool activeBiais, bool onlyUseBiaisForFirstHiddenLayer,
    double biaisValue)
    : NeuralNetwork(weights, nbInputs, nbOutputs)
    , _activeBiais(activeBiais)
...
LayeredNeuralNetwork::LayeredNeuralNetwork(LayeredNeuralNetwork const& other)
    : NeuralNetwork(other)
{
...
bool LayeredNeuralNetwork::getActiveBiais() const { return _activeBiais; }
...
double LayeredNeuralNetwork::getBiaisValue() const { return _biaisValue; }
