...
std::string MLP::toString() const { return LayeredNeuralNetwork::toString(); }
...
std::string MLP::getNNTypeName() { return "MLP"; }

MLP* MLP::clone() const { return new MLP(*this); }
